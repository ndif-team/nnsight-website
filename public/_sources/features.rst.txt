...
.. grid:: 1 1 2 2
   ...
   .. grid-item-card:: 
      :link: notebooks/features/skip.ipynb
      :class-card: surface
      :class-body: surface
      ...
      .. raw:: html
         ...
         <div class="d-flex align-items-center">
            ...
            <div>
               ...
               <p class="card-text">Skip module execution</p>
            </div>
         </div>

   .. grid-item-card:: 
      :link: notebooks/features/source.ipynb
      :class-card: surface
      :class-body: surface
      ...
      .. raw:: html
         ...
         <div class="d-flex align-items-center">
            <div class="d-flex justify-content-center" style="min-width: 50px; margin-right: 15px; height: 100%;">
               <i class="fa-solid fa-xmarks-lines fa-2x"></i>
            </div> 
            <div>
               <h5 class="card-title">Source</h5>
               <p class="card-text">Access and intervene on intermediate values</p>
            </div>
         </div>
