...
.. grid:: 1 1 2 2
   ...
   .. grid-item-card:: 
      :link: notebooks/mini-papers/huang_demystifying_memorization.ipynb
      :class-card: surface
      :class-body: surface
      ...
      .. raw:: html
         ...
         <div class="d-flex align-items-center">
            ...
            <div>
               <h5 class="card-title">Demystifying Memorization</h5>
               <p class="card-text">When & how do LLMs memorize text?</p>
            </div>
         </div>

   .. grid-item-card:: 
      :link: notebooks/mini-papers/feucht_dual_route_induction.ipynb
      :class-card: surface
      :class-body: surface
      ...
      .. raw:: html
         ...
         <div class="d-flex align-items-center">
            <div class="d-flex justify-content-center" style="min-width: 50px; margin-right: 15px; height: 100%;">
               <i class="fa-solid fa-arrows-split-up-and-left fa-2x"></i>
            </div> 
            <div>
               <h5 class="card-title">Concept Induction Heads</h5>
               <p class="card-text">LLMs distinguish between tokens & concepts</p>
            </div>
         </div>
...
.. toctree::
   ...
   notebooks/mini-papers/huang_demystifying_memorization
   notebooks/mini-papers/feucht_dual_route_induction