...
![NNsight-vLLM request lifecycle](vllm-integration-assets/nnsight_vllm_lifecycle.svg)
...
![Column-parallel (all-gather) vs row-parallel (all-reduce) at TP=2](vllm-integration-assets/nnsight_vllm_tp.svg)
