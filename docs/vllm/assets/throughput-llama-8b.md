...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| generate | 92 | 86 | 89 | 86 | 90 | 86 | 92 | ✗ | ✗ |
| generate, 8 concurrent | 618 | 577 | 597 | 580 | 596 | 578 | 616 | ✗ | ✗ |
...
| one forward over 512 tokens, capture 1 layer | 45 ms | 53 ms | 53 ms | **43 ms** | **44 ms** | **45 ms** | 37 ms | 98 ms | 62 ms |
| sweep: 1024 × 1 token, capture 1 layer, per request | 0.75 s | 1.60 s | 1.48 s | · | · | **1.33 s** | 0.76 s | 7.18 s | 25.90 s |
