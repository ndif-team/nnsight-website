...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| generate | 91 | 67 | 88 | 69 | 88 | 68 | 91 | ✗ | ✗ |
| generate, 8 concurrent | 604 | 471 | 583 | **496** | 580 | **490** | 605 | ✗ | ✗ |
...
| one forward over 512 tokens, capture 1 layer | 44 ms | 54 ms | 55 ms | **43 ms** | **46 ms** | **45 ms** | 37 ms | 101 ms | 51 ms |
| sweep: 1024 × 1 token, capture 1 layer, per request | 0.78 s | 1.74 s | 1.59 s | · | · | **1.41 s** | 0.77 s | 6.64 s | 23.75 s |
